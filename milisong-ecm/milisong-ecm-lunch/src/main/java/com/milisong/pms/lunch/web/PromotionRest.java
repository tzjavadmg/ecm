...
public class PromotionRest {
    ...
    @Autowired
    private RestPromotionService promotionService;
...
//    }
    ...
    ResponseResult<UserRedPacketResponse> recevieMultiShareRedPacket(@PathVariable("orderid") Long orderid){
    ...
    ResponseResult<Pagination<UserRedPacketDto>> myRedpacket(@RequestBody ActivityRedPacketQueryParam queryParam) {
