...
import com.milisong.pms.breakfast.service.lc.LCClientPromotionService;
...
@Slf4j
@RestController
@RequestMapping("/lc/v1/promotion/client/")
public class LCPromotionClientRest {

    @Autowired
    private LCClientPromotionService promotionService;
