...
public class RestFeedbackService {
     ...
     * @return
     */
    public ResponseResult<List<UserFeedbackTypeDto>> feedbackType(Boolean transit) {
        FeedbackTypeDto userFeedback = new FeedbackTypeDto();
        userFeedback.setBusinessLine(OrderType.BREAKFAST.getValue());
        userFeedback.setTransit(transit);
        return feedbackService.feedbackType(userFeedback);
    }
