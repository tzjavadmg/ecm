...
public class OrderHelperLC {
    ...
    public VirtualOrderParam fillVirtualOrderParam(VirtualOrderParam virtualOrderParam) {
        ...
        BigDecimal deliveryOriginalPrice = shopConfigServiceLC.getDeliveryOriginalPrice(shopCode);
        BigDecimal deliveryActualPrice = shopConfigServiceLC.getDeliveryDiscountPrice(shopCode);
        BigDecimal packageOriginalPrice = shopConfigServiceLC.getPackageOriginalPrice(shopCode);
        BigDecimal packageActualPrice = shopConfigServiceLC.getPackageDiscountPrice(shopCode);
        Date cutOffOrderTime = shopConfigServiceLC.getTodayLastCutOffTime(shopCode);
    ...
    public OrderPaymentParam fillOrderPaymentParam(OrderPaymentParam orderPaymentParam) {
        ...
        List<ShopConfigDto.DeliveryTimezone> timezones = shopConfigServiceLC.getDeliveryTimezones(orderPaymentParam.getShopCode());
