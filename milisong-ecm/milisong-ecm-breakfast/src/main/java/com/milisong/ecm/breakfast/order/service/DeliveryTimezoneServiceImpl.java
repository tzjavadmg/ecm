 ...
 */
@RestController
public class DeliveryTimezoneServiceImpl implements DeliveryTimezoneService {
    ...
    public ResponseResult<List<TimezoneDto>> getAllDeliveryTimezones(Byte businessLine, String shopCode) {
        List<ShopConfigDto.DeliveryTimezone> deliveryTimes = shopConfigService.getDeliveryTimezones(shopCode);
