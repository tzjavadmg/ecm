...
public class NofityTaskRest {
    ...
    public void notifyTodayOrder() {
        log.info("-----发送9点提醒短信-----");
        NotifyTodayOrderTaskDto taskDto = new NotifyTodayOrderTaskDto();
        taskDto.setBusinessLine(BusinessLineEnum.BREAKFAST.getVal());
        notifyService.notifyTodayOrderTask(taskDto);
    }
