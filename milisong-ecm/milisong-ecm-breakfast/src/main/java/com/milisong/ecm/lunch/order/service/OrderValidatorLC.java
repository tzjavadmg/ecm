...
//        DeliveryTimezoneParam deliveryTimezoneParam = firstDeliveryTimezoneParam;
...
//        }
//        log.info("---------------截单时间配置：{}",JSON.toJSONString(deliveryTimezoneParam));
        Date currentCutOffTime = DateTimeUtils.mergeDateAndTimeString(orderDate, orderPaymentParam.getCutoffTime());
        Date lastCutOffTime = shopConfigServiceLC.getTodayLastCutOffTime(orderPaymentParam.getShopCode());
