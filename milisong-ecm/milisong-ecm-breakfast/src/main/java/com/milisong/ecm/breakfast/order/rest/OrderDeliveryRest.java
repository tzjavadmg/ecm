...
import com.milisong.ecm.breakfast.order.service.DeliveryTimezoneService;
...
@RestController
@Slf4j
public class OrderDeliveryRest {
    ...
    ResponseResult<?> getAllDeliveryTimezones(@RequestParam(value = "shopCode", required = true) String shopCode) {
        ...
        return deliveryTimezoneService.getAllDeliveryTimezones(OrderType.BREAKFAST.getValue(), shopCode);
    }
    ...
    ResponseResult<?> getAllAvailableDeliveryTimezones(@RequestParam(value = "shopCode", required = true) String shopCode, @DateTimeFormat(pattern = "yyyy-MM-dd") Date deliveryDate) {
        ...
        return deliveryTimezoneService.getAvailableTimezones(OrderType.BREAKFAST.getValue(), shopCode, deliveryDate);
    }
