...
import com.milisong.pms.lunch.service.RestMarketingQrcodeService;
...
public class MarketingQrcodeRest {
    ...
    ResponseResult<List<MarketingQrcodeDto>> qrcodeList() {
        return marketingQrcodeService.qrcodeList();
    }
