...
public class GoodsScheduleRest {
	...
	public ResponseResult<GoodsScheduleLunchInfoDto> getGoodsScheduleInfoByWeek(@RequestParam("year")Integer year,@RequestParam("weekOfYear")String weekOfYear,@RequestParam("shopId")Long shopId){
	...
	public ResponseResult<String> saveGoodsScheduleInfo(@RequestBody GoodsScheduleLunchParam goodsScheduleParam){
	...
	public ResponseResult<List<GoodsScheduleLunchDto>> getDateByShopId(@RequestParam("shopId") Long shopId){
