...
*@date  2018年12月6日---下午3:50:57
*
*/
@Component
public class GainschaBillTemplateByTscAndBreakfast {
		 ...
		 * @return
		 */
		public byte[] customerTemplate(List<OrderSetDetailGoodsDto> listCustomer, Map<String, Object> map,int number,int count) {
			...
			for (OrderSetDetailGoodsDto orderSetDetailGoodsDto2 : listCustomer) {
				...
				if(orderSetDetailGoodsDto2.getGoodsNumber()>1) {
					label.addText(170, row, FONTTYPE.SIMPLIFIED_CHINESE,
							ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
							"【 "+orderSetDetailGoodsDto2.getGoodsNumber()+" * "+orderSetDetailGoodsDto2.getGoodsName()+" 】");

				}else {
					label.addText(200, row, FONTTYPE.SIMPLIFIED_CHINESE,
							ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
							orderSetDetailGoodsDto2.getGoodsNumber()+" * "+orderSetDetailGoodsDto2.getGoodsName());
...
//			label.addText(200, row+300, FONTTYPE.SIMPLIFIED_CHINESE,
//					ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
//					"第："+number+"/"+count+"张");
			label.addPrint(1);
			label.addFeed(2);
		 ...
		 * @return
		 */
		public byte[] customerTemplateCombo(List<OrderSetDetailGoodsDto> listCustomer, Map<String, Object> map, List<OrderSetDetailGoodsDto> list,int number,int count) {
			OrderSetDetailGoodsDto  orderSetDetailGoodsDto = listCustomer.get(0);
			...
			label.addDirection(DIRECTION.BACKWARD, MIRROR.NORMAL);
			label.addReference(10,10);
			label.addText(10, 100, FONTTYPE.SIMPLIFIED_CHINESE,
					ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
					"第"+number+"/"+count+"张");
			label.addText(240, 100, FONTTYPE.SIMPLIFIED_CHINESE,
					ROTATION.ROTATION_0, FONTMUL.MUL_2, FONTMUL.MUL_2,
					orderSetDetailGoodsDto.getUserName());
			label.addText(100, 150, FONTTYPE.SIMPLIFIED_CHINESE,
					ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
					map.get("deliveryTime")+" 送达 手机尾号:("+StringUtils.convertMobileLas(orderSetDetailGoodsDto.getUserPhone())+")");
			label.addText(1, 160, FONTTYPE.SIMPLIFIED_CHINESE,
					ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
					"_____________________________________________________");
			label.addText(180, 195, FONTTYPE.SIMPLIFIED_CHINESE,
					ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
					orderSetDetailGoodsDto.getComboGoodsName());
			
			int row = 205;
			for (OrderSetDetailGoodsDto orderSetDetailGoodsDto2 : listCustomer) {
				row = row +30;
				int goodsCount = (orderSetDetailGoodsDto2.getGoodsNumber()/orderSetDetailGoodsDto.getComboGoodsCount());
				if(goodsCount>1) {
					label.addText(170, row, FONTTYPE.SIMPLIFIED_CHINESE,
							ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
							"【 "+1+" * "+orderSetDetailGoodsDto2.getGoodsName()+"】");
				}else {
					label.addText(200, row, FONTTYPE.SIMPLIFIED_CHINESE,
							ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
							(orderSetDetailGoodsDto2.getGoodsNumber()/orderSetDetailGoodsDto.getComboGoodsCount())+" * "+orderSetDetailGoodsDto2.getGoodsName());
				}
			...
			if(!CollectionUtils.isEmpty(list)) {
				...
				label.addText(180, row , FONTTYPE.SIMPLIFIED_CHINESE,
						ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
						"单品:");
				for (OrderSetDetailGoodsDto orderSetDetailGoodsDto2 : list) {
					row = row +30;
					int goodsCount = orderSetDetailGoodsDto2.getGoodsNumber();
					if(goodsCount>1) {
						label.addText(170, row, FONTTYPE.SIMPLIFIED_CHINESE,
								ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
								"【 "+goodsCount+" * "+orderSetDetailGoodsDto2.getGoodsName()+"】");
					}else {
						label.addText(200, row, FONTTYPE.SIMPLIFIED_CHINESE,
								ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
								goodsCount+" * "+orderSetDetailGoodsDto2.getGoodsName());
...
//					ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
//					"------------------------------------------------------");
			label.addText(1, row+40, FONTTYPE.SIMPLIFIED_CHINESE,
					ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
					"_____________________________________________________");
			label.addText(10, (row+90), FONTTYPE.SIMPLIFIED_CHINESE,
					ROTATION.ROTATION_0, FONTMUL.MUL_2, FONTMUL.MUL_2,
			...
			label.addText(160, row+260, FONTTYPE.SIMPLIFIED_CHINESE,
					ROTATION.ROTATION_0, FONTMUL.MUL_2, FONTMUL.MUL_2,
					StringUtils.subStringSetNo(map.get("setNo").toString()));
//			label.addText(250, row+300, FONTTYPE.SIMPLIFIED_CHINESE,
//					ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
//					"第："+number+"/"+count+"张");
			label.addPrint(1);
			label.addFeed(2);
