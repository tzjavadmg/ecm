...
public class SendCouponWater implements Serializable {
    private Long id;
    ...
    public Long getSendCouponRecordId() {
        return sendCouponRecordId;
    }

    public void setSendCouponRecordId(Long sendCouponRecordId) {
        this.sendCouponRecordId = sendCouponRecordId;
    }
    ...
    public boolean equals(Object that) {
        ...
        SendCouponWater other = (SendCouponWater) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getSendCouponRecordId() == null ? other.getSendCouponRecordId() == null : this.getSendCouponRecordId().equals(other.getSendCouponRecordId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSendCouponRecordId() == null) ? 0 : getSendCouponRecordId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", sendCouponRecordId=").append(sendCouponRecordId);
