 ...
 * @description
 */
public class ActivityScanQrcode implements Serializable {
    private Long id;
    ...
    public void setGiftIds(String giftIds) {
        this.giftIds = giftIds == null ? null : giftIds.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        ActivityScanQrcode other = (ActivityScanQrcode) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getGiftIds() == null ? other.getGiftIds() == null : this.getGiftIds().equals(other.getGiftIds()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getGiftIds() == null) ? 0 : getGiftIds().hashCode());
